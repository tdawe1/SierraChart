...
Reference copies of external study sources, synced 2026-09-12.
...
|---|---|---|---|
| `vendor/sierrachart-studies/` | `tdawe1/SierraChartStudies` (`/home/user/SierraChartStudies`) | 2026-09-12 | `Orion.cpp`, `orion_core.h`, `FlipperStudies.cpp`, `SatyPivotRibbon.cpp`, `DiscordAlerts.cpp`, `InitialBalanceStatistics.cpp`, `PropRiskOverlay.cpp` (untracked upstream worktree file), `BacktestExporter.cpp` (from `backtest/exporter/`) |
| `vendor/frozentundra/` | `FrozenTundraTrader/sierrachart` (`/home/user/sierrachart`) | 2026-09-12 | 15× `.cpp` + `helpers.h` (needed by `JIGSAW_Export.cpp`) |
| `vendor/jm-jo-nq100/` | `JM-JO/Sierra-Chart---DLLs` (`src/`, `/home/user/Sierra-Chart---DLLs`) | 2026-09-12 | 19× French NQ100 `.cpp` |
